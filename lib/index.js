...
/**
 * addAxiosRoutePreHookFactory will generate a Hapi Route Pre hook and assign the output Axios client to the passed in `assign` value.
 *
 * @param {String} assign Defaults to 'axios'. The name of the key to set the returned value on the `request.pre.<assign>` object.
 * @returns {{method: (function(*=): AxiosInstance), assign: string}}
 */
...
/**
 * addAxiosRoutePreHook is a helper method that generates a default Route Pre hook with the output Axios client assigned to `request.pre.axios`
 *
 * @type {{method: (function(*=): AxiosInstance), assign: string}}
 */
